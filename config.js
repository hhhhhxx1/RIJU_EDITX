...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:5292ac675c203b0b4fd477748a7e9cb5";
const SUDO = process.env.SUDO || '917364934516';
...
const BOT_INFO = process.env.BOT_INFO || "RIJU;RIJUY;https://i.imgur.com/xi2j9dW.jpeg";
const URL = process.env.URL || "https://www.instagram.com/ofx_riju?igsh=ZHc0cTR6OTgyMTAz";
const AUDIO_DATA = process.env.AUDIO_DATA || "RIJU;RIJUKY;https://i.imgur.com/xi2j9dW.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "RIJU;RIJU<3";
